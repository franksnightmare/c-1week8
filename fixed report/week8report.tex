...
\lstinputlisting[caption = index operator]{src/matrix/operator[].cc}
\lstinputlisting[caption = const index operator]{src/matrix/operator[]const.cc}
...
\lstinputlisting[caption = rowextractor.cc]{src/matrix/rowextractor.cc}
\lstinputlisting[caption = columnextractor.cc]{src/matrix/columnextractor.cc}
